				...
				<div className="ms-2 flex flex-grow flex-col rounded-xl border border-neutral-200 p-4 text-sm dark:border-neutral-700 sm:ms-3 sm:text-base">
					...
					<div className="relative flex items-center pe-6">
						<div className="absolute -end-3 -top-3">
							<NcDropDown
								className={`flex items-center justify-center rounded-lg p-2 text-neutral-500 hover:text-neutral-800 dark:hover:bg-neutral-800 dark:hover:text-neutral-200 sm:hover:bg-neutral-100 ${twFocusClass()}`}
								data={actions}
