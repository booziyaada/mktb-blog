	...
	return (
		...
		>
			<div className="z-10 -mt-8 w-full px-3 sm:px-6 md:absolute md:start-0 md:top-1/2 md:mt-0 md:w-3/5 md:-translate-y-1/2 md:px-0 lg:w-1/2 xl:w-2/5">
				<div className="nc-CardLarge1__left space-y-3 rounded-3xl bg-white/40 p-4 shadow-lg backdrop-blur-lg backdrop-filter dark:bg-neutral-900/40 dark:shadow-2xl sm:space-y-5 sm:p-8 md:px-10 xl:py-14">
			...
			<div className="w-full md:w-4/5 lg:w-2/3">
				<Link href={href} className="nc-CardLarge1__right relative block">
					{/* <NcImage
